...
class AcceptedTasks extends StatefulWidget {
  const AcceptedTasks({Key? key}) : super(key: key);

  @override
  State<AcceptedTasks> createState() => _AcceptedTasksState();
}

class _AcceptedTasksState extends State<AcceptedTasks> {
      ...
      body: Container(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              ...
              .where('status_task', isEqualTo: 'Accepted tasks')
              .snapshots(),
